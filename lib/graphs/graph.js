...
export class Graph {
    ...
    appendVertex(vertex) {
        vertex.addActionListener(ACTION_TYPE.EDGE_CONN_CLICK_ACTION, this.edgeConnectorClick, [this]);
    ...
    edgeConnectorClick(that, pointer, vertex, edgeConnector) {
        console.log('graph', that);
        console.log('pointer', pointer);
        console.log('vertex', vertex);
        console.log('edgeConnector', edgeConnector);
    }
}