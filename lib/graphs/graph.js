...
export class Graph {
    ...
    init() {
        ...
        this.edgeDrawListener = new EdgeDrawEvent(this.svgMainG);
        this.resize();
    ...
    addListenerDefaults() {
        ...
        // edge is added
        this.edgeDrawListener.addActionListener(ACTION_TYPE.GRAPH_EDGE_ADDED_ACTION, this.edgeConnectorIsAdded, [this]);
    }
    ...
    update() {
        //TODO I need to investigate how the re-rendering of existing elements is going to work
        // as of now I don't ever re-draw anything but I will have to if I want to implement 
        // drag/moving events on blocks.... 
        let that = this;
    ...
    edgeConnectorIsAdded(type, that, vertexHolderA, vertexHolderB) {
        console.log('edgeConnectorIsAdded');
        if (type == ACTION_TYPE.GRAPH_EDGE_ADDED_ACTION) {
            that.edges.append(new Edge(vertexHolderA, vertexHolderB));
            that.update();
        }
    }
}