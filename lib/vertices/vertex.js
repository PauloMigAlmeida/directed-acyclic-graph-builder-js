...
export class Vertex extends BaseActionListener {
    ...
    draw(graph) {
        if (this.drawingContext === null) {
            ...
            this.inputs.forEach((value) => {
                value.addActionListener(ACTION_TYPE.EDGE_CONN_DRAG_START_ACTION, this.edgeConnectorGenericDragEventCallback, [this]);
                value.addActionListener(ACTION_TYPE.EDGE_CONN_DRAGGING_ACTION, this.edgeConnectorGenericDragEventCallback, [this]);
                value.addActionListener(ACTION_TYPE.EDGE_CONN_DRAG_END_ACTION, this.edgeConnectorGenericDragEventCallback, [this]);
    ...
    /**
     * Handler for the edge connector drag start event
     ...
     */
    edgeConnectorGenericDragEventCallback(type, that, pointer, edgeConnector){
        that.listeners
